...
const SUPPORTED_PLATFORMS: PlatformConfig[] = [
  ...
  },
  {
    ...
    name: 'Medium',
    badgeColor: '#00AB6C',
    description: 'Distribute stories to Medium with canonical links. (Note: Medium discontinued issuing new tokens in Jan 2025; existing tokens remain active).',
    secretLabel: 'Medium Integration Token',
    secretPlaceholder: 'e.g. 2e4b8f... (existing token)',
    helpText: 'Medium discontinued new tokens in 2025; enter an existing Integration Token if you have one',
